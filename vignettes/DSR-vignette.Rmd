...
This vignette documents the method for calculating DSRs using
...
This is a fairly common scenario, especially when working with small populations where there may be no deaths in some of the younger age groups. From PHEindicatormethods version 1.1.0 onwards, the calculate_dsr function can handle this scenario and will assume a zero death count where it is missing or recorded as NA.  

Let's create a couple of data frames to demonstrate this.  In this example, there are no deaths in the 10-14, 15-20 and 20-14 age bands:
