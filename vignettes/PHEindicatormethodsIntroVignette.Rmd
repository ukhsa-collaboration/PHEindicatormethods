...
#    css: style.css
#vignette: >
#  %\VignetteIndexEntry{Vignette demonstrating the PHEindicatormethods package functions}
...
Here are some example code chunks to demonstrate the phe_smr and phe_isr functions and the arguments that can optionally be specified
...
The phe_isr function works exactly the same way but instead of expressing the result as a ratio of the observed and expected rates the result is expressed as a rate and the reference rate is also provided:
