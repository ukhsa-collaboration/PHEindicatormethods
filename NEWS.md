...
1. Users can now specify whether events are independent.  For non-independent events the data must be broken down by person-event-frequency and the function will perform an adjustment to the confidence interval calculation. 
