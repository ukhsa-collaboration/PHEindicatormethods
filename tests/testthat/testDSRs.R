...
test_that("dsrs and CIs calculate correctly",{
  ...
  expect_equal(unlist(select(ungroup(calculate_dsr(test_multiarea_esp, count, pop,
                                                   stdpop = esp2013,)),7)),
               c("95%", "95%", "95%"),
...
test_that("dsrs - errors are generated when invalid arguments are used",{
  ...
  expect_error(calculate_dsr(test_multiarea_esp, count, pop,  stdpop = esp2013,
  ...
  expect_error(calculate_dsr(test_DSR_nonind, persons, pop, stdpop = esp2013,
